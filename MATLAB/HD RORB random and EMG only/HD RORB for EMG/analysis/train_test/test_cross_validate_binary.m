function [out, model,testAM] = test_cross_validate_binary(model, features, N)
    ...
    for trial = 1:numTrials
        ...
        for g = 1:numGests
            ...
            for i = 1:testLength-model.N+1
                ...
                ngram = ngram_iscas(segment, model);
                ngram = binarize_vec(ngram);
                for c = 1:numTests
                    [sims(c,i,:), outLabel(c,i)] = classify_iscas_fast_hamming(ngram, testAM{testIdx(c)});
                end
            end
