...
class Ui_GestureTraining(object):
    def setupUi(self, GestureTraining):
        GestureTraining.setObjectName(_fromUtf8("GestureTraining"))
        GestureTraining.resize(455, 127)

        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(GestureTraining.sizePolicy().hasHeightForWidth())
        GestureTraining.setSizePolicy(sizePolicy)
        ...
        GestureTraining.setWidget(self.dockWidgetContents)

        self.retranslateUi(GestureTraining)
        QtCore.QMetaObject.connectSlotsByName(GestureTraining)

    def retranslateUi(self, GestureTraining):
        GestureTraining.setWindowTitle(_translate("GestureTraining", "EMG Gesture Training", None))
