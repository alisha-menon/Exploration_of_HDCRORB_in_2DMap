user_changepoint_detection Executable
...
================================
-run_user_changepoint_detection.sh (shell script for temporarily setting environment 
 variables and executing the application)
   -to run the shell script, type
   
       ./run_user_changepoint_detection.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/v97, run the shell script as:
       ...
       ./run_user_changepoint_detection.sh /mathworks/home/application/v97
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_user_changepoint_detection.sh /mathworks/devel/application/matlab
-MCRInstaller.zip 
    Note: if end users are unable to download the MATLAB Runtime using the
    instructions in the previous section, include it when building your 
    component by clicking the "Runtime included in package" link in the
    Deployment Tool.
-The Macintosh bundle directory structure user_changepoint_detection.app 
    Note: this can be stored in an archive file with the zip command 
    zip -r user_changepoint_detection.zip user_changepoint_detection.app
    or the tar command 
    tar -cvf user_changepoint_detection.tar user_changepoint_detection.app
-This readme file 
...
${DYLD_LIBRARY_PATH}:MR/v97/runtime/maci64:MR/v97/sys/os/maci64:MR/v97/bin/maci64
   ...
   Distribute in the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, you can
              run the shell script file run_user_changepoint_detection.sh 
